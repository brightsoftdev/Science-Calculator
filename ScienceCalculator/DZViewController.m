...
- (void)viewDidLoad
{
    ...
    self.exprLabel.text = [calculator displayExpression];
    self.numberLabel.adjustsFontSizeToFitWidth = YES;
    //self.exprLabel.adjustsFontSizeToFitWidth = YES;
    self.exprLabel.lineBreakMode = UILineBreakModeHeadTruncation;
    self.exprLabel.textAlignment = UITextAlignmentRight;
    self.shiftIsPressed = NO;
    self.hypIsPressed = NO;
    self.degIsPressed = YES;
    self.ledM.image = nil;
